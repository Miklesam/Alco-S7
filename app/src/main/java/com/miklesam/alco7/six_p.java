...
public class six_p extends AppCompatActivity {
    private InterstitialAd mInterstitialAd;
    ArrayList cardlist= new ArrayList();
    boolean not_first_init;
    int num;
    boolean[] had_have=new boolean[6];
    boolean[] had_eight=new boolean[6];
    ...
    TextView NumCards;
    ImageView[] Eight= new ImageView[6];
    Button InfoButton;
    ImageView Cardtaken;
    Button Throwcard;
    Button Backtomenu;
    ...
    ImageView turn[] = new ImageView[6];
    ImageView Player[] = new ImageView[6];
    ImageView Ten[] = new ImageView[6];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_six_p);
        ...
        turn[2]=findViewById(R.id.turn5);
        turn[3]=findViewById(R.id.turn7);
        turn[4]=findViewById(R.id.turn8);
        turn[5]=findViewById(R.id.turn11);

        Player[0]=findViewById(R.id.player2);
        Player[1]=findViewById(R.id.player3);
        Player[2]=findViewById(R.id.player5);
        Player[3]=findViewById(R.id.player7);
        Player[4]=findViewById(R.id.player8);
        Player[5]=findViewById(R.id.player11);

        Ten[0]=findViewById(R.id.ten_2);
        Ten[1]=findViewById(R.id.ten_3);
        Ten[2]=findViewById(R.id.ten_5);
        Ten[3]=findViewById(R.id.ten_7);
        Ten[4]=findViewById(R.id.ten_8);
        Ten[5]=findViewById(R.id.ten_11);

        Eight[0]=findViewById(R.id.eight_2);
        Eight[1]=findViewById(R.id.eight_3);
        Eight[2]=findViewById(R.id.eight_5);
        Eight[3]=findViewById(R.id.eight_7);
        Eight[4]=findViewById(R.id.eight_8);
        Eight[5]=findViewById(R.id.eight_11);
